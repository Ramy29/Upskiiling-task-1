...
<div className="max-w-screen-xl mx-auto my-7 lg:px-20" id="contact">
  <form action method="post">
    <div className="w-full p-8 my-4 mr-auto shadow-2xl md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 rounded-2xl">
      ...
      <div className="my-4">
        <textarea placeholder="Message" className="w-full h-32 p-3 mt-2 text-gray-900 bg-gray-100 rounded-lg focus:outline-none focus:shadow-outline" name="message" autoComplete="message" defaultValue={""} />
      </div>
